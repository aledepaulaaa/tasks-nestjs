...
describe('CollaboratorsService', () => {
    ...
    it('should return a paginated list of collaborators by project', async () => {
        jest.spyOn(prisma.projectCollaborator, 'findMany').mockResolvedValue(
            mockedCollaborators as any,
        )
        jest.spyOn(prisma.projectCollaborator, 'count').mockResolvedValue(
